...
module.exports = function (d) {
    ...
    for (let i = 0; i < data.int.length; i++) {
        ...
        ////////////////////////////////////////////////////////////
        //format the long "date" field into short date and time separately using moment.js
        data.int[i].d = moment(data.int[i].date).format("YYYY-MM-DD");
        data.int[i].t = moment(data.int[i].date).format("HH:mm:ss");
